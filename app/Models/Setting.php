...
class Setting extends Model
{
    ...
    public const SECRET_KEYS = ['google_client_secret', 'line_client_secret', 'app_github_token', 'turnstile_secret', 'bscscan_api_key', 'fb_page_token', 'fb_app_secret', 'fb_user_token', 'fcm_service_account', 'line_oa_token'];
