    ...
    <div class="flex flex-col gap-5">
        ...
        <div class="nx-card p-5">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                {{-- "% ตรงใจ" and "คะแนน" fields removed: both columns are now always null. Their
                     values were generated by random_int() at import, and a hand-typed score would be
                     just as invented. Ratings come from members via the star control on /watch. --}}
